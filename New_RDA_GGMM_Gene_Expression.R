...
pivot_Resp_Matrix <- dcast(Resp_Matrix, Station ~ CC, value.var = "Gene_Expression", fill = 0)
...
#### The RDA (on Hellinger-transformed and z-centred data)
...
png("RDA_Hellinger_UNKNOWNS_GGMM_GeneExpression.png", width = 800, height = 1000)
